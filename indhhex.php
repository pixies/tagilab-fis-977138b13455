...
<div class="col s12 m6 l6"><!-- Bloco de 3 Materias Principais - Primeira coluna -->
     ...
     <div class="card" style="padding-bottom: 6px; box-shadow:none;">
  ...
  <!-- faco o loop so da categoria 20 e trago 1 so post -->
   <div class="card" style="padding-bottom: 6px; box-shadow:none;">
    ...
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="http://www.newsrondonia.com.br/imagensNoticias/image/logo_fiesbrasil_.jpg" style="height: 374px;">
    </div>
    <div class="card-content">
